...
class database
{
    ...
    function tambah_dosen ($nidn, $nama, $matkul, $alamat) {
        mysqli_query($this -> koneksi, "insert into dosen (nidn, nama, matkul, alamat) values ('$nidn', '$nama', '$matkul', '$alamat')");
    }
    ...
    function update_dosen ($id, $nidn, $nama, $matkul, $alamat) {
        mysqli_query($this -> koneksi, "update dosen set nidn='$nidn', nama='$nama', matkul='$matkul', alamat='$alamat' where id='$id'");
    }
